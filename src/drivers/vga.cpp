...
uint8_t VideoGraphicsArray::GetColorIndex(uint8_t r, uint8_t g, uint8_t b){
    ...
    if(r == 0x00 && g == 0x00 && b == 0xA8) return 0x11;    //blue
    if(r == 0x00 && g == 0xA8 && b == 0x00) return 0x02;    //green
    if(r == 0xA8 && g == 0x00 && b == 0x00) return 0x04;    //red
    if(r == 0xFF && g == 0xFF && b == 0xFF) return 0x3F;    //white
    if(r == 0x80 && g == 0x80 && b == 0x80) return 0x07;    //gray
    if(r == 0x90 && g == 0x90 && b == 0x90) return 0x03;    //gray
...
/*colors left = this projects pallete, right = this pallete https://www.fountainware.com/EXPL/vgapalette.png
